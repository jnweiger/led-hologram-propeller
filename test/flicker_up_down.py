...
for frame in range(20):  
  ...
  pix = im.load()
  if frame & 1:
    putdot(pix, 0, 0, color=(255,0,255), size=(w, h/2))
  else:
    putdot(pix, 0, h/2, color=(255,0,255), size=(w, h/2))
  frames.append(im)

frames[0].save('flicker_up_down.gif', format='GIF', append_images=frames[1:], save_all=True, duration=int(1000./15), loop=0)
